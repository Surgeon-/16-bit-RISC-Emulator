...
${OBJECTDIR}/Asem-SymTab.o: Asem-SymTab.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Asem-SymTab.o Asem-SymTab.cpp

${OBJECTDIR}/CPrint.o: CPrint.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPrint.o CPrint.cpp

${OBJECTDIR}/VM87-Runtime.o: VM87-Runtime.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VM87-Runtime.o VM87-Runtime.cpp

${OBJECTDIR}/ZMain.o: ZMain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ZMain.o ZMain.cpp
